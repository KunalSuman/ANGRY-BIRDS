...
public class Pause extends ScreenAdapter {
    ...
    public Pause(Main main ,TiledMap T1,int return_number){
        ...
        to_menu.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, 725);
        ...
        retry_button.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, 625);
        ...
        Save_quit.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, 525);
        ...
        quit_button.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, 425 );
        ...
        settings.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, 325);
        ...
        return_button.setPosition((Gdx.graphics.getWidth() - pause_menu.getWidth()*0.42f) / 2f, (Gdx.graphics.getHeight() - pause_menu.getHeight()*0.955f) / 2f);

...
public class Yellow_bird extends Birds_schema implements Birds{
    Yellow_bird(Body body, World world, Texture Red_bird , int velocity , int ability , int hitpoints , String name , int locked) {
